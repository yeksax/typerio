...
import { creatorFloat, creatorIntersection, creatorText } from "@/atoms/creatorAtom";
...
export default function PostCreator({ user }: Props) {
	...
	const creatorNode = (
		<div
			className={`border-b-2 flex flex-col relative border-black bg-white px-4 py-1.5 md:px-8 md:py-4`}
		>
	...
	return (
		<AnimatePresence>
			{isFloating ? (
				...
				<div key='fixed-creator'>{creatorNode}</div>
			)}
